...
parser.add_argument("--todo_path", type=str, default=os.path。join(script_dir, "todo.txt"), help="生成 todo.txt 的路径，默认脚本同级目录的 todo.txt")
parser.add_argument("--done_path", type=str, default=os.path。join(script_dir, "done.txt"), help="生成 done.txt 的路径，默认脚本同级目录的 done.txt")
